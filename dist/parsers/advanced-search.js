...
class AdvancedSearchParser {
    ...
    advancedParseResultsItems(_a) {
        return __awaiter(this, arguments, void 0, function* ({ data, options }) {
            ...
            let items = [];
            yield Promise.all(data.map((_a) => __awaiter(this, [_a], void 0, function* ({ _source: source, highlight, inner_hits, matched_queries }) {
                var _b, _c, _d;
                let itemResult = {
                    highlights: [],
                };
                ...
                if (inner_hits && Object.keys(inner_hits)) {
                    for (var prop in inner_hits) {
                        ...
                        const xml_filename = ((_c = (_b = conf[searchId]) === null || _b === void 0 ? void 0 : _b.xml_search_options) === null || _c === void 0 ? void 0 : _c.field_filename) ||
                            'xml_filename';
                        ...
                        if (doc) {
                            ...
                            if (hh.length > 0 && ((_d = hh[0]) === null || _d === void 0 ? void 0 : _d.isTitle)) {
