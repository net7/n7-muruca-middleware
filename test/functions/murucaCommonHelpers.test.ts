...
describe('Common Helpers', function commonHelpersTest() {
  ...
  context('Get xml tag stripped', function () {
    it('should return a text without tags', async function () {
      ...
      expect(test).eq("La vita è imprevedibile. Accetta gli errori e le sfide, sii coraggioso e non dimenticare di apprezzare le cose belle. La vita è imprevedibile. Accetta gli errori e le sfide, sii coraggioso e non dimenticare di apprezzare le cose belle.");
    });
  })
