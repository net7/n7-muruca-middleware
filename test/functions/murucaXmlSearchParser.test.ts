...
describe('XML Text parser', function commonHelpersTest() {
  ...
  const hlNode = {
    ...
    "highlight": {
      "xml_transcription_texts_json.quote._refs.author": [
        "Livio"
      ],
      "xml_transcription_texts_json.quote._refs.title": [
        "Ab urbe cond."
      ],
      "xml_transcription_texts_json.quote.xml_text": [
        hl_text
      ]
    }
  }
  ...
  context('Get A formatted node', function () {
    ...
    it('should return an xml tag with attributes', async function () {
      ...
      expect(xml_node).eq("<quote source='"+xml_source+"' >"+hl_text+"</quote>");      
    });
